...
/**
 * <p>
 * Java class for ReleaseType complex type.
 * 
 * <p>
...
@XmlType(name = "ReleaseType", propOrder = { "grossEstimateConversionRatio", "name", "notes", "plannedVelocity",
		"project", "releaseDate", "releaseStartDate", "revisionHistory", "state", "theme", "version" })
public class ReleaseType extends WorkspaceDomainObjectType {
