...
@XmlType(name = "UserPermissionType", propOrder = { "customOid", "name", "role", "user" })
@XmlSeeAlso({ WorkspacePermissionType.class, ProjectPermissionType.class })
public class UserPermissionType extends DomainObjectType {
